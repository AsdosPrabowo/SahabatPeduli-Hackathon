...
// Array yang berisi 38 provinsi di Indonesia
const provincesList = [
  ...
  "Nusa Tenggara Timur", "Papua", "Papua Barat", "Papua Tengah", "Papua Pegunungan",
  "Papua Selatan", "Papua Barat Daya", "Riau", "Sulawesi Barat", "Sulawesi Selatan",
                ...
                <div className='form-group-1'>
                  ...
                  >
                    ...
                    {provincesList.map((province, index) => (
                      <option key={index} value={province.toLowerCase().replace(/ /g, '-')}>
                        {province}
                      </option>
                    ))}
                  </select>
